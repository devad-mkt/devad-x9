...
| Item | Exact identity |
|---|---|
| Cached skill | `$CODEX_HOME\plugins\cache\openai-curated-remote\superpowers\6.1.1\skills\using-git-worktrees\SKILL.md` |
...
or a host-created native worktree under `$DEVAD_ROOT\0-cdx-wt`, disables manual
