...
### From `CODEX__ultra-reasoning-protocol`

### False-blocker normalization
Before accepting a worker or Looper claim containing `BLOCKED`, `WAITING`,
`FROZEN`, `HARD_BOUNDARY`, `RESUME_ON`, or `OWNER_REQUIRED`, normalize it
...
Canonical body: `z-think` (2026-08-13 00:38:44, 11 files, sha256 `4d93a2fa380b1fd1`).

Former names now disabled: `CODEX/ultra-reasoning-protocol`, `NINELLC/ultra-reasoning-protocol`.
