...
explicit `$z-loop-code` trial, it may instead consume an accepted canonical
...
Canonical body: `z-docs` (2026-08-13 00:38:44, 3 files, sha256 `177e9faec0d00e60`).

Former names now disabled: `CODEX/x9-project-docs`, `NINELLC/x9-project-docs`.
