...
Current pilot uses Sol medium as Linx's fixed baseline, Sol xhigh for normal
Thinx strategy, Sol ultra for one high-risk Thinx pass, and Sol high for
bounded Worker debugging. The Thinx return gate and sidecar bridge are active;
other task-class choices remain pilots until the promotion gate passes.
